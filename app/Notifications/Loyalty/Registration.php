...
class Registration extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $url = \Bitly::getUrl('https://users.cyranocrm.it/landing/' . $this->project->getRouteKey() . '/register?email=' . urlencode($c->encrypt($notifiable->email)));
    ...
    public function toTwilio($notifiable)
    {
        ...
        $url = \Bitly::getUrl('https://users.cyranocrm.it/landing/' . $this->project->getRouteKey() . '/register?phone=' . urlencode($c->encrypt($notifiable->phone)));
